...
import { removeTerminal } from "../features/userSlice";

const StaffTerminalModal = ({
  setStaffTerminalModal,
  companyId,
  terminalId,
  setCompanyId,
  setTerminalId,
...
export default StaffTerminalModal;
